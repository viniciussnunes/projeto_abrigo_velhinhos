    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto" >
          ...
          <li class="nav-item"><a href="/publicacao" style="color: white; font-weight: 400; font-size: 20px" class="nav-link">Criar Publicação</a></li>
          ...
          <li class="nav-item"><a href="/cadastroVoluntarioRelatorio" style="color: white; font-weight: 400; font-size: 20px" class="nav-link">Registro de Voluntários</a></li>
        </ul>
      </div>
    </div>
</nav>
